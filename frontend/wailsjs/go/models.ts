...
export namespace main {
	...
	export class VariableNodeWriteRequest {
	    nodeID: string;
	    targetValue: string;
	
	    static createFrom(source: any = {}) {
	        return new VariableNodeWriteRequest(source);
	    }
	...
	export class VariableNodeWriteResult {
	    nodeID: string;
	    targetValue: string;
	    status: string;
	    readBack: opcua.LiveValue;
	    warning: string;
	
	    static createFrom(source: any = {}) {
	        return new VariableNodeWriteResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.readBack = this.convertValues(source["readBack"], opcua.LiveValue);
